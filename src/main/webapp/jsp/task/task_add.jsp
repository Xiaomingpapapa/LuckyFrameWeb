		...
		<article class="col-sm-9 maincontent" style="width:100%;">
			...
			<sf:form modelAttribute="taskjob" method="post"	onsubmit="return validTime(this);">
				<table width="70%" align="center" class="rect" height=582
					...
					<tr id="ehiappfileselect" style="display: none">
						<td width="140" height="32">testNG文件填写</td>
						<td height="32" colspan="3"><sf:input path="testngFile"
															  id="testngFile" cssClass="easyui-validatebox" required="false"
															  value="testng.xml"/></td>
					</tr>
					<tr>
					...
					<tr id="scriptserverbaseurl" style="display: none">
						...
						<td height="32" colspan="3"><sf:input path="baseUrl"
															  id="baseUrl" cssClass="easyui-validatebox" required="false"
															  value="localhost:10000"/></td>
					</tr>
